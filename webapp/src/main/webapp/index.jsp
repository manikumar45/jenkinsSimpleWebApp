...
<head>
    <meta charset="UTF-8">
    <title>Manikumar shopping website</title>
...
<body>
    ...
    <section id="home">
        <header>
            <span style="font-size:64px;margin-right:10px;color:orange">Manikumar shopping website</span>
            <ul id="menu">
         ...
         <h1> **** Flipkart mobile offers available until 4th apr 2025 **** </h1>   
